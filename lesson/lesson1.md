...
- Реализуйте класс `com.basejava.wepapp.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `com.basejava.wepapp.MainArray.main()` и `com.basejava.wepapp.MainTestArrayStorage.main()`
...
6. `com.basejava.wepapp.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
...
1. Не меняйте сигнатуры методов в `com.basejava.wepapp.storage.ArrayStorage`
